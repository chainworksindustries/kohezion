...
const char * const BITCOIN_CONF_FILENAME = "kohezion.conf";
...
{
    // Windows: C:\Users\Username\AppData\Roaming\Kohezion
    // macOS: ~/Library/Application Support/Kohezion
    // Unix-like: ~/.kohezion
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Kohezion";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Kohezion";
#else
    // Unix-like
    return pathRet / ".kohezion";
#endif
#endif
}
