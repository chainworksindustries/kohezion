...
{
    switch (unit) {
    case Unit::BTC: return QString("KHZ");
    case Unit::mBTC: return QString("mKHZ");
    case Unit::uBTC: return QString::fromUtf8("µKHZ (kyts)");
    case Unit::SAT: return QString("Kohezionoshi (sat)");
...
QString BitcoinUnits::shortName(Unit unit)
{
    ...
    case Unit::uBTC: return QString("kyts");
...
{
    switch (unit) {
    case Unit::BTC: return QString("Kohezion");
    case Unit::mBTC: return QString("Milli-Kohezion (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-Kohezion (kyts) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    case Unit::SAT: return QString("Kohezionoshi (sat) (1 / 100" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    } // no default case, so the compiler can warn about missing cases
    assert(false);
}
